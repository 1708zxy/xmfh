            ...
            function e(d, e) {
                ...
                function s(a) {
                    ...
                    var b = 0 === ab,
                        ...
                        f = a / _,
                        g = -f * (V - S);
                    (wb != b || yb != e) && (wb = b, yb = e, d.trigger("easy-arrow-change", [wb, yb, xb, zb])),
                        v(b, e),
                        Q.css("top", g),
                ...
                function u(a) {
                    ...
                    var b = 0 === db,
                        ...
                        f = a / cb,
                        g = -f * (U - R);
                    (xb != b || zb != e) && (xb = b, zb = e, d.trigger("easy-arrow-change", [wb, yb, xb, zb])),
                        w(b, e),
                        Q.css("left", g),
                ...
                var P, Q, R, S, T, U, V, W, X, Y, Z, $, _, ab, bb, cb, db, eb, fb, gb, hb, ib, jb, kb, lb, mb, nb, ob,
                    pb, qb, rb, sb, tb, ub, vb = this,
                    wb = !0,
                    xb = !0,
                    yb = !1,
                    zb = !1,

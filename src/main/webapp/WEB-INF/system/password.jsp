...
<div class="left_box navbg1">
 ...
 <div class="user_left or">
  <ul>
   ...
   <li><a href="#"><i class="u2"></i>修改昵称</a></li>
   <li class="on"><a href="#"><i class="u3"></i>修改密码</a></li>
...
<div class="user_right bgf or">
 ...
 <div class="con">
  ...
  <tr>
    <td height="54" align="right"><strong>原密码</strong></td>
    <td><input type="password" class="txt w1" placeholder="请输入"></td>
  </tr>
  <tr>
    <td height="54" align="right"><strong>新密码</strong></td>
    <td><input type="password" class="txt w1" placeholder="请输入"> <span><img src="images/qiangdu.jpg"> 密码强度：强</span></td>
  </tr>
  <tr>
    <td height="54" align="right"><strong>确认新密码</strong></td>
    <td><input type="password" class="txt w1" placeholder="请输入"><span class="wr"><i></i>密码输入不一致</span></td>
  </tr>
</table>

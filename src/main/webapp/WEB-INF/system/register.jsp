...
<form id="demo1" method="post" autocomplete="off" data-validator-option="{theme:'yellow_top'}" action="/RegisterController/save">
    <div class="establish bgf">
        <div class="con">
            ...
            <ul>
                ...
                <li><input type="text" class="txt" placeholder="请输入邮箱（用户密码找回）"  name="FEmail"
                           data-rule="邮箱: required; email;"
                           data-msg-email="{0}邮箱" placeholder="邮箱"></li>
                <li>
                    <input type="text" class="ldf" placeholder="请输入验证码" data-rule="验证码: required;Idf" >
                    <img src="${ctx}/staticfile/images/1.bmp" >
                <li>

...
<div class="header bgf">
    ...
    <div class="con">
        ...
        <a href="#" class="dl" onclick="formSubmit('${ctx}/tocreate.action','_self');">注 册</a>
    </div>
</div>
<div class="login">
    <div class="login_con">
            ...
            <div class="establish bgf">
                <div class="con">
                    ...
                    <ul>
                        ...
                        <li><input type="checkbox" checked><label>两周内自动登录</label></li>
                        <li><input type="submit" class="btn" value="用户登录" onclick="formSubmit('${ctx}/login.action','_self');" /></li>
                        <li><p>还没有帐号？<a href="#"onclick="formSubmit('${ctx}/tocreate.action','_self');">立即注册</a></p></li>
                    </ul>
                </div>
            </div>
        </form>
